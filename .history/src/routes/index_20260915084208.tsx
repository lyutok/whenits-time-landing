...
import exploreScreen from "../assets/screen-explore.png.asset.json";
import overlapScreen from "../assets/screen-hero-overlap.png.asset.json";
import notifyScreen from "../assets/screen-notify-me.png.asset.json";
import remindersScreen from "../assets/screen-reminders.png.asset.json";
import workingHoursScreen from "../assets/screen-working-hours.png.asset.json";
    ...
    <main className="day-story">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-phone phone-wrap" data-reveal>
          <img src="./src/assets/screen-hero-overlap.png"alt="WhenItsTime showing the overlap between Paris and New York" />
        </div>
      ...
      <section className="feature feature-overlap">
        ...
        <div className="phone-stage overlap-stage" data-reveal>
          ...
          <div className="phone-wrap"><img loading="lazy" src={overlapScreen.url} alt="Working-hours overlap in WhenItsTime" /></div>
        </div>
      </section>

      <section className="feature feature-explore">
        <div className="phone-stage explore-stage" data-reveal>
          <div className="phone-wrap"><img loading="lazy" src={exploreScreen.url} alt="Explore view with New York, Paris, and Chiang Mai" /></div>
        </div>
        <div className="section-copy" data-reveal>
      ...
      <section className="feature feature-hours">
        ...
        <div className="phone-stage hours-stage" data-reveal>
          <div className="phone-wrap"><img loading="lazy" src={workingHoursScreen.url} alt="Working hours settings in WhenItsTime" /></div>
        </div>
      </section>
      ...
      <section className="reminder-section">
        ...
        <div className="reminder-screens" data-reveal>
          <div className="phone-wrap phone-back"><img loading="lazy" src={remindersScreen.url} alt="Active reminders in WhenItsTime" /></div>
          <div className="phone-wrap phone-front"><img loading="lazy" src={notifyScreen.url} alt="Reminder options in WhenItsTime" /></div>
        </div>
      </section>
      ...
      <section className="human-section">
        <div className="human-inner" data-reveal>
          ...
          <p>Friends. Family. Clients. People who live somewhere else.</p>
        </div>
      </section>

      <section className="for-section">
        <p className="eyebrow" data-reveal>Who it’s for</p>
        <div className="for-list">
          {[
            ["For the friend", "who moved away."],
            ["For the family", "on the other side of the world."],
            ["For the client", "who works nine hours behind you."],
            ["For the trip", "you’re planning across time zones."],
            ["For you", "when you just don’t want to think about the clock."],
          ].map(([lead, text]) => (
            <div className="for-row" data-reveal key={lead}><strong>{lead}</strong><span>{text}</span></div>
          ))}
        </div>
      </section>
      ...
      <section className="pro-section" id="pro">
        <div className="pro-intro" data-reveal>
          ...
          <h2>Make it part<br />of your day.</h2>
          <p>Keep more places, explore more cities, and never run out of reminders.</p>
        </div>
